    ...
    : describe("DynamicSvgNft Test", async function () {
          ...
          describe("mintNft", async () => {
              it("emits an event and creates the NFT", async () => {
                  ...
                  const toukenCounter = await dynamicSvgNft.getTokenCounter()
                  assert.equal(toukenCounter.toString(), "1")
